...
namespace ModelTests
{
    ...
    public class ReservationCampingGuestTest
    {
        ...
        public void TestReservationCampingGuestConstructorCorrect()
        {
            ...
            CampingGuest campingGuest = new CampingGuest("2", "1", "testName", "19/10/21");
            ...
            ReservationCampingGuest reservationCampingGuest = new ReservationCampingGuest(reservation, campingGuest);
        ...
        [Test]
        public void TestReservationCampingGuestLongConstructorCorrect()
        {
            Account account = new Account("1", "admin", "nimda",  "1");
            CampingGuest campingGuest = new CampingGuest("2", "1", "testName", "19/10/21");
