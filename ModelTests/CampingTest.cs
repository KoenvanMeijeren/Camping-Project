...
namespace ModelTests
{
    ...
    public class CampingTest
    {
        ...
        public void TestCampingConstructorCorrect()
        {
            ...
            Camping camping = new Camping("testName", address, campingOwner, "0341234565", "admin@nimda.com", "https://www.facebook.com", "https://www.twitter.com", "https://www.instagram.com");
        ...
        public void TestCampingLongConstructorCorrect()
        {
            ...
            Camping camping = new Camping("123", "testName", address, campingOwner, "0341234565", "admin@nimda.com", "https://www.facebook.com", "https://www.twitter.com", "https://www.instagram.com");
        ...
        {
            Camping camping = new Camping(null, null, null, null, null, null, null, null, null);
            Assert.AreEqual(camping.Id, -1);
